...
Out of curiosity and if you don't mind sharing, what are you looking for in terms of pay to start out?

Also, what would you say are your strengths and what exactly is your ideal role? Since you already have a tutor, I'm guessing you do plenty of code reviews, but it might not hurt to take a look at something you've done (codewise) and see where that might place you in terms of getting a foot in the door. If it's not JS of any variety (I can help you with that), I know a couple of guys who would make time to look over your work - one guy in particular who is pretty proficient in a lot of languages and would definitely give me the straight dish.

Just an idea anyway. Sorry it took me a bit to respond. I've been under the weather the last couple of days.


Mike,

As for pay I think getting a job that provided a solid path forward (good environment / team, growth) is probably more important than salary.

If we just manage to nealry break even the first year or so that is not a problem... Julia might dissagree.
But we are used to being somewhat uncomfortable having lived in a tiny apartment in Seoul.

We are not desperate as we saved a good chunk of money and had some luck with crypto currencies over the past year :)

As for strengths, I think I have had a pretty broad exposure to multiple technologies full-stack and front-end but somewhat limited on a specific technology.
SQL, Node and express, basic Rails Crud and authentication, testing

The ideal position would be a front-end position developing in React.
Especially in a role where being able to understand the full stack is valuable.
I feel comfortable with SCSS, mobile first design, and flexbox.

Being in the Bay Area data-structures and algorithms seem to be the differentiator for getting into a company.

I have been working on things like binary search trees, dynamic programming, stacks, queues etc... and practicing for the technical interview for the past couple months.

This means I have not been writing as much code for actual projects. 
Over the next month I will be shifting the focus back to exploring React more.

A couple of months ago I built a React app while learning the framework and really enjoyed it.

Instead of diving into Redux I spent more time trying to figure out how to create re-useable components.

I also wanted to better understand how to encapsulate css inside a specific component so that there are fewer css collisions.

The direction I took was with the styled-components library
  docs
https://www.styled-components.com/docs/basics
  evolution article
https://medium.com/@perezpriego7/css-evolution-from-css-sass-bem-css-modules-to-styled-components-d4c1da3a659b

So basically splitting each component into a container and a component where the container holds all the js logic and the component holds the css.
There are also a bunch of other cool tricks that the library gives you like rendering svg images, and easy acess to global variables for maipulating things like colors, fonts, and media queries.
https://github.com/Nalipp/Stat-su/blob/master/react-ui/src/TimeSlip/ItemCnt.js
https://github.com/Nalipp/Stat-su/blob/master/react-ui/src/TimeSlip/SummaryItemCpt.js

Anyway.. it'ss a first stab at it, I hope to be around people who regularly develop in this area.

I think I am starting to get into blog-post teritory with this message lol. 

But writing all of this has been a great way to prepare for thinking about React again.

It would be awesome if someone wanted to take a look at my code. My tutor has a background in academic computer science, not so much with building software.

For the most part I haven't goten a lot of access to other coders.

Today I had a great meeting with Dan Klos from Outco and it went really well, it is starting to look like thier could be possible options in the teaching direction as well.
...
People like you are the kind of magic I always envisioned existing here :)

Here is more info about the courses we talked about from Udemy if you are curious.

Colt Steele
  https://www.udemy.com/the-web-developer-bootcamp/

Rithm School and Colt Steele
  https://www.udemy.com/the-advanced-web-developer-bootcamp/learn/v4/overview

Stephen Grider
  He has a lot of courses but this one is on preparing for the technical interview
  https://www.udemy.com/coding-interview-bootcamp-algorithms-and-data-structure/learn/v4/overview

I hope we can make a connection again in the future!
